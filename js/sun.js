(function(){
    ...
    export: function() {
      ...
      switch(RENDER.renderer) {
        ...
        case CANVAS:
          ...
          break;
        case SVG:
          var data = encodeURIComponent(sun.innerHTML);
      ...
      resize(sun_container.offsetWidth, sun_container.offsetHeight);
    }
  };
  ...
  var sun_container = document.getElementById('sun_container');
  ...
  function setRenderer(index) {
    if (renderer) {
      sun.removeChild(renderer.element);
    }
    switch(index) {
      case WEBGL:
    ...
    renderer.setSize(sun_container.offsetWidth, sun_container.offsetHeight);
    sun.appendChild(renderer.element);
  }
  ...
  function addEventListeners() {
    ...
    sun_container.addEventListener('click', onMouseClick);
    sun_container.addEventListener('mousemove', onMouseMove);
  }
