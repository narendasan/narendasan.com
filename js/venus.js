      ...
      switch(RENDER.renderer) {
        case WEBGL:
          ...
          case CANVAS:
            ...
            break;
            case SVG:
              var data = encodeURIComponent(venus.innerHTML);
            ...
            resize(venus_container.offsetWidth, venus_container.offsetHeight);
          }
        };
        ...
        var venus_container = document.getElementById('venus_container');
        ...
        function setRenderer(index) {
          if (renderer) {
            venus.removeChild(renderer.element);
          }
          switch(index) {
            case WEBGL:
              ...
              case CANVAS:
                ...
                renderer.setSize(venus_container.offsetWidth, venus_container.offsetHeight);
                venus.appendChild(renderer.element);
              }
                  ...
                  function render() {
                    ...
                    if (LIGHT.draw) {
                      ...
                      function addEventListeners() {
                        ...
                        venus_container.addEventListener('click', onMouseClick);
                        venus_container.addEventListener('mousemove', onMouseMove);
                      }
