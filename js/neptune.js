      ...
      switch(RENDER.renderer) {
        case WEBGL:
          ...
          case CANVAS:
            ...
            break;
            case SVG:
              var data = encodeURIComponent(neptune.innerHTML);
            ...
            resize(neptune_container.offsetWidth, neptune_container.offsetHeight);
          }
        };
        ...
        var neptune_container = document.getElementById('neptune_container');
        ...
        function setRenderer(index) {
          if (renderer) {
            neptune.removeChild(renderer.element);
          }
          switch(index) {
            case WEBGL:
              ...
              case CANVAS:
                ...
                renderer.setSize(neptune_container.offsetWidth, neptune_container.offsetHeight);
                neptune.appendChild(renderer.element);
              }
                  ...
                  function render() {
                    ...
                    if (LIGHT.draw) {
                      ...
                      function addEventListeners() {
                        ...
                        neptune_container.addEventListener('click', onMouseClick);
                        neptune_container.addEventListener('mousemove', onMouseMove);
                      }
