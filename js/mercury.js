      ...
      switch(RENDER.renderer) {
        case WEBGL:
          ...
          case CANVAS:
            ...
            break;
            case SVG:
              var data = encodeURIComponent(mercury.innerHTML);
            ...
            resize(mercury_container.offsetWidth, mercury_container.offsetHeight);
          }
        };
        ...
        var mercury_container = document.getElementById('mercury_container');
        ...
        function setRenderer(index) {
          if (renderer) {
            mercury.removeChild(renderer.element);
          }
          switch(index) {
            case WEBGL:
              ...
              case CANVAS:
                ...
                renderer.setSize(mercury_container.offsetWidth, mercury_container.offsetHeight);
                mercury.appendChild(renderer.element);
              }
                  ...
                  function render() {
                    ...
                    if (LIGHT.draw) {
                      ...
                      function addEventListeners() {
                        ...
                        mercury_container.addEventListener('click', onMouseClick);
                        mercury_container.addEventListener('mousemove', onMouseMove);
                      }
