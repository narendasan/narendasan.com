      ...
      switch(RENDER.renderer) {
        case WEBGL:
          ...
          case CANVAS:
            ...
            break;
            case SVG:
              var data = encodeURIComponent(jupiter.innerHTML);
            ...
            resize(jupiter_container.offsetWidth, jupiter_container.offsetHeight);
          }
        };
        ...
        var jupiter_container = document.getElementById('jupiter_container');
        ...
        function setRenderer(index) {
          if (renderer) {
            jupiter.removeChild(renderer.element);
          }
          switch(index) {
            case WEBGL:
              ...
              case CANVAS:
                ...
                renderer.setSize(jupiter_container.offsetWidth, jupiter_container.offsetHeight);
                jupiter.appendChild(renderer.element);
              }
                  ...
                  function render() {
                    ...
                    if (LIGHT.draw) {
                      ...
                      function addEventListeners() {
                        ...
                        jupiter_container.addEventListener('click', onMouseClick);
                        jupiter_container.addEventListener('mousemove', onMouseMove);
                      }
