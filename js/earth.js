      ...
      switch(RENDER.renderer) {
        case WEBGL:
          ...
          case CANVAS:
            ...
            break;
            case SVG:
              var data = encodeURIComponent(earth.innerHTML);
            ...
            resize(earth_container.offsetWidth, earth_container.offsetHeight);
          }
        };
        ...
        var earth_container = document.getElementById('earth_container');
        ...
        function setRenderer(index) {
          if (renderer) {
            earth.removeChild(renderer.element);
          }
          switch(index) {
            case WEBGL:
              ...
              case CANVAS:
                ...
                renderer.setSize(earth_container.offsetWidth, earth_container.offsetHeight);
                earth.appendChild(renderer.element);
              }
                  ...
                  function render() {
                    ...
                    if (LIGHT.draw) {
                      ...
                      function addEventListeners() {
                        ...
                        earth_container.addEventListener('click', onMouseClick);
                        earth_container.addEventListener('mousemove', onMouseMove);
                      }
