      ...
      switch(RENDER.renderer) {
        case WEBGL:
          ...
          case CANVAS:
            ...
            break;
            case SVG:
              var data = encodeURIComponent(mars.innerHTML);
            ...
            resize(mars_container.offsetWidth, mars_container.offsetHeight);
          }
        };
        ...
        var mars_container = document.getElementById('mars_container');
        ...
        function setRenderer(index) {
          if (renderer) {
            mars.removeChild(renderer.element);
          }
          switch(index) {
            case WEBGL:
              ...
              case CANVAS:
                ...
                renderer.setSize(mars_container.offsetWidth, mars_container.offsetHeight);
                mars.appendChild(renderer.element);
              }
                  ...
                  function render() {
                    ...
                    if (LIGHT.draw) {
                      ...
                      function addEventListeners() {
                        ...
                        mars_container.addEventListener('click', onMouseClick);
                        mars_container.addEventListener('mousemove', onMouseMove);
                      }
