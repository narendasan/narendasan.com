      ...
      switch(RENDER.renderer) {
        case WEBGL:
          ...
          case CANVAS:
            ...
            break;
            case SVG:
              var data = encodeURIComponent(uranus.innerHTML);
            ...
            resize(uranus_container.offsetWidth, uranus_container.offsetHeight);
          }
        };
        ...
        var uranus_container = document.getElementById('uranus_container');
        ...
        function setRenderer(index) {
          if (renderer) {
            uranus.removeChild(renderer.element);
          }
          switch(index) {
            case WEBGL:
              ...
              case CANVAS:
                ...
                renderer.setSize(uranus_container.offsetWidth, uranus_container.offsetHeight);
                uranus.appendChild(renderer.element);
              }
                  ...
                  function render() {
                    ...
                    if (LIGHT.draw) {
                      ...
                      function addEventListeners() {
                        ...
                        uranus_container.addEventListener('click', onMouseClick);
                        uranus_container.addEventListener('mousemove', onMouseMove);
                      }
