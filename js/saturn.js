      ...
      switch(RENDER.renderer) {
        case WEBGL:
          ...
          case CANVAS:
            ...
            break;
            case SVG:
              var data = encodeURIComponent(saturn.innerHTML);
            ...
            resize(saturn_container.offsetWidth, saturn_container.offsetHeight);
          }
        };
        ...
        var saturn_container = document.getElementById('saturn_container');
        ...
        function setRenderer(index) {
          if (renderer) {
            saturn.removeChild(renderer.element);
          }
          switch(index) {
            case WEBGL:
              ...
              case CANVAS:
                ...
                renderer.setSize(saturn_container.offsetWidth, saturn_container.offsetHeight);
                saturn.appendChild(renderer.element);
              }
                  ...
                  function render() {
                    ...
                    if (LIGHT.draw) {
                      ...
                      function addEventListeners() {
                        ...
                        saturn_container.addEventListener('click', onMouseClick);
                        saturn_container.addEventListener('mousemove', onMouseMove);
                      }
