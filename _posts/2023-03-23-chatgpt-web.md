...
<details>
Services like Facebook, Instagram, where content is hidden behind a login screen I'd argue are not part of the open web in the same way that content in paywalled research repositories aren't. They serve as hints of what a ChatGPT based web looks like. Walled social media applications successfully pulled the individual out of the **open** web. The prevailance of personal websites, blogs, etc. has gone down in the last 10 years. ChatGPT threatens to do something similar to the greater web.
</details>
<br>

The fact that it feels like LM-based chatbots are the next step in interacting with the internet creates a forcing function to be a first class member in that world and plugins seem like it will be the mechanism to do so. Will people find you or your service if you're not integrated into ChatGPT? Google already has been criticized for centralizing and arbitrating traffic on the web[^16] and many actors have taken to optimizing their content to best fit Google. The implications of this new UI takes that world a step further. Ultimately, what backstopped Google's information was human readable, openly accessible content. There is always the ability to push through or go around Google and get to some sort of readable webpage. Language models (especially hosted ones) themselves are absolutely not human readable, and with plugins the need for a human readable raw corpus becomes optional once people have transitioned to using LM-based systems. Even additional training data can be captured monitoring human input and by querying plugins. Content can more easily be centralized in privately maintained and heavily accessed controlled repositories and mediated through primarily web APIs with no requirement for an open readable option.
...
[^19]: [https://www.youtube.com/watch?v=ogzsDTBh1T0](https://www.youtube.com/watch?v=ogzsDTBh1T0)
[^20]: [https://www.npr.org/sections/therecord/2011/03/18/134598010/for-better-or-worse-mp3s-are-the-format-of-choice](https://www.npr.org/sections/therecord/2011/03/18/134598010/for-better-or-worse-mp3s-are-the-format-of-choice)
[^21]: [https://healthcare.utah.edu/healthfeed/2022/09/impact-of-social-media-teens-mental-healt](https://healthcare.utah.edu/healthfeed/2022/09/impact-of-social-media-teens-mental-health)
[^22]: [https://thediplomat.com/2020/05/facebooks-apology-for-its-role-in-sri-lankas-anti-muslim-riots-should-spark-change/](https://thediplomat.com/2020/05/facebooks-apology-for-its-role-in-sri-lankas-anti-muslim-riots-should-spark-change/)
