...
2. The Code Evangelism Hackathon vision is no longer relevant.
   ...
   3. It’s easier to plan events for beginners, after all you can teach them everything. However, not much thought is dedicated to providing for participants who are not first time programmers or hackathoners?
...
4. Companies that are not platform based (e.g. Amazon) see very little value in evangelizing their products at current style of hackathon.
